...
public class OnlineLoginActivity extends AppCompatActivity {
    ...
    ListView lvLoginUsers;
    ArrayList<String> listLoginUsers = new ArrayList<>();
    ArrayAdapter adpt;

    ListView lvRequestedUsers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvLoginUsers = (ListView) findViewById(R.id.lvLoginUsers);
        adpt = new ArrayAdapter(this, android.R.layout.simple_list_item_1,listLoginUsers);
        lvLoginUsers.setAdapter(adpt);
        ...
        lvRequestedUsers = findViewById(R.id.lvRequestUsers);
        reqUsersAdpt = new ArrayAdapter(this, android.R.layout.simple_list_item_1,listRequestedUsers);
        lvRequestedUsers.setAdapter(reqUsersAdpt);
...
//                    tvUserID.setPaintFlags(tvUserID.getPaintFlags() |   Paint.UNDERLINE_TEXT_FLAG);
                    SpannableString content = new SpannableString("Logged as: " + LoginUserID);
                    content.setSpan(new UnderlineSpan(), 11, content.length(), 0);
                    tvUserID.setText(content);
        ...
        lvLoginUsers.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
        ...
        lvRequestedUsers.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
